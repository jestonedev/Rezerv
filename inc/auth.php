...
define("AUTH_ROOT_DEPARTMENT_REQUEST",524288);     //Право позволяет подавать заявки непосредственно на департамент (иначе только на свой отдел)
define("AUTH_MANAGE_TRANSPORT",1048576);           //Право позволяет менять информацию по автотранспорту
