...
$(document).ready(function(){
    ...
    var rep_with_car_id = [15,35,36,37,38,40];               //идентификаторы отчетов со списком выбора автомобилей
    var rep_without_dep_and_date_type = [17,35,36,37,38,40]; //идентификаторы отчетов без списка выбора департамента и типа даты
